...
{//This controller exposes a number of actions like Register(), LogIn(), LogOff() etc...
    [Authorize]
    public class AccountController : Controller
    {
        ...
        {//This method is just used to return the 'Register' view
            return View();
        }

        //The below Register action is called when we post a form
